...
public class ClassReaderTest {
	...
	public void testStuff() throws IOException {
		...
		try (InputStream fis = new FileInputStream(path);) {
			...
			assertEquals(TestClass.class.getName(), reader.getClassName());
			assertEquals(Object.class.getName(), reader.getSuperClassName());
			Field[] reflectionFields = TestClass.class.getDeclaredFields();
			FieldInfo[] fields = reader.getFields();
			...
			MethodInfo[] constructors = reader.getConstructors();
			...
			MethodInfo[] methods = reader.getMethods();
